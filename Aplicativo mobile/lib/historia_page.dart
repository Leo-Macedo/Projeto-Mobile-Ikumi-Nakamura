      ...
      appBar: AppBar(
        title: Container(
          ...
          child: Text(
            'História',
            style: TextStyle(
                fontSize: 30, color: Color.fromARGB(255, 241, 203, 252)),
          ),
        ),
      ),
      body: Stack(children: [
