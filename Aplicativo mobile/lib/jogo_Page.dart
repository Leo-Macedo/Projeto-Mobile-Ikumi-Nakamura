          ...
          child: ListView.builder(
            ...
            itemBuilder: (context, index) {
              return Column(
                children: [
                  Conteudo(
                    titulo: conteudosJogos[index].titulo,
                    texto: conteudosJogos[index].texto,
                    img: conteudosJogos[index].img,
                  ),
                ],
              );
            },
...
List<ClasseConteudo> conteudosJogos = [
  okami,
  bayonetta,
  marvelVsCapcom3,
...
class ClasseConteudo {
  late String titulo;
  late String texto;
  late String img;

  ClasseConteudo(this.titulo, this.texto, this.img);
}

ClasseConteudo okami = ClasseConteudo(
  'Ōkami (2006)',
  ...
  'assets/img/Okami.jpg',
);

ClasseConteudo bayonetta = ClasseConteudo(
  'Bayonetta (2009)',
  ...
  'assets/img/bayonetta.jpg',
);

ClasseConteudo marvelVsCapcom3 = ClasseConteudo(
...
ClasseConteudo streetFighterXTekken = ClasseConteudo(
...
ClasseConteudo ultraStreetFighterIV = ClasseConteudo(
  ...
  'assets/img/ultra.jfif',
);

ClasseConteudo theEvilWithin = ClasseConteudo(
...
ClasseConteudo streetFighterV = ClasseConteudo(
  ...
  'assets/img/streetV.jpg',
);

ClasseConteudo theEvilWithin2 = ClasseConteudo(
  ...
  'assets/img/evil2.jpg',
);

ClasseConteudo ghostwireTokyo = ClasseConteudo(
...
ClasseConteudo gungraveGore = ClasseConteudo(
  'Gungrave GORE (2022)',
